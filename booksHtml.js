...
//                        <button class="shop" onclick="addCart(event); changeColor(event)"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
